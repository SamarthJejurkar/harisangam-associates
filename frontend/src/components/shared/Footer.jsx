...
//             <a href="mailto:studio@harisangam.com" className="hover:text-gold transition-colors">EMAIL</a>
...
export default function Footer() {
  return (
    <footer className="bg-charcoal text-cream/80 py-16 px-6 md:px-12">
      ...
      <div className="max-w-7xl mx-auto mt-12 pt-6 border-t border-cream/10 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-cream/40 tracking-wide">
        <span>© {new Date().getFullYear()} Harisangam & Associates. All rights reserved.</span>
        <span className="text-cream/25">Powered by Nexyor</span>
      </div>
    </footer>
  );
}